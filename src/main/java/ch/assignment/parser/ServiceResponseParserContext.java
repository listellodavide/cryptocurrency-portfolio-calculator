...
/**
 * ServiceResponseParserContext class follow the Strategy Pattern
 * @since 1.0
 * @author davide.listello@gmail.com
 */
public class ServiceResponseParserContext {
    private ServiceParserStrategy parser;

    public void setServiceResponseParserStrategy(ServiceParserStrategy parser) {
        this.parser = parser;
    }

    public ServiceResponseEntry parseServiceResponse(String input) throws ParseException {
        return parser.parseServiceResponse(input);
    }
